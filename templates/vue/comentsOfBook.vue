...
<section id="take-comments">
    <div>
        ...
        <div class = "row">
            ...
            <td v-if="user == 1"class= "titTabla"><h2>Borrar comentario</h2></td>

            <tr v-if="comentario.texto" v-for="comentario in comentarios">
            <td>{{ comentario.apellido }} {{ comentario.nombre }}</td>
